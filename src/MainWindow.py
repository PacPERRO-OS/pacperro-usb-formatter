...
APPNAME = "pacperro-usb-formatter"
...
class MainWindow:
    def __init__(self, application):
        ...
        # Import UI file:
        self.builder.add_from_file(os.path.dirname(os.path.abspath(__file__)) + "/../pacperro-usb-formatter.glade")
    ...
    def sendNotification(self, title, body):
        ...
        notification.set_icon(Gio.ThemedIcon(name="pacperro-usb-formatter"))
